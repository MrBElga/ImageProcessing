...
namespace ProcessamentoImagens
{
    public partial class frmPrincipal : Form
    {
        ...
        private void verticalSemDMA_Click(object sender, EventArgs e)
        {
            Bitmap imgDest = new Bitmap(image);
            imageBitmap = (Bitmap)image;
        ...
        private void verticaLComDMA_Click(object sender, EventArgs e)
        {
            Bitmap imgDest = new Bitmap(image);
            imageBitmap = (Bitmap)image;
            Filtros.espelhoVerticalComDMA(imageBitmap, imgDest);
            pictBoxImg2.Image = imgDest;
        }

        private void horizontalSemDMA_Click(object sender, EventArgs e)
        {
            Bitmap imgDest = new Bitmap(image);
            imageBitmap = (Bitmap)image;
        ...
        private void hotizontalComDMA_Click(object sender, EventArgs e)
        {
            Bitmap imgDest = new Bitmap(image);
            imageBitmap = (Bitmap)image;
            Filtros.espelhoHorizontalComDMA(imageBitmap, imgDest);
            pictBoxImg2.Image = imgDest;
        }
    }
}
